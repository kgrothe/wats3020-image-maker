...
class ImageMaker {
    constructor(){
        ...
        this.imagePreview = document.getElementById('image-preview'); // select image-preview div
        
        this.topText = document.createElement('p'); // create topText <p> element 
        
        this.topText.setAttribute('class', 'top-text'); // add class attribute
        
        this.imagePreview.appendChild(this.topText); // append as child element
        
        this.bottomText = document.createElement('p'); // create bottomText <p> element
        
        this.bottomText.setAttribute('class', 'bottom-text'); // add class attribute
        
        this.imagePreview.appendChild(this.bottomText); // append as child element            
            
       // Read user input from form fields    
     
        this.backgroundInput = document.querySelector('select[name="backgroundImage"]'); // select backgroundImage input
   
        this.topTextInput = document.querySelector('input[name="topText"]'); // select topText input
     
        this.bottomTextInput = document.querySelector('input[name="bottomText"]');  // select bottomText input
    ...
    drawPreview(){
        ...
        this.imagePreview.style.backgroundImage = `url(images/${this.backgroundInput.value})`; // update background image
     
        this.topText.innerHTML = this.topTextInput.value; // update topText
        
        this.bottomText.innerHTML = this.bottomTextInput.value; // update bottomText        
